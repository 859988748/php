...
function phpReader($file_url){
	...
	for ($row=2; $row < $highestRow; $row++) { 
		# code...
		$rawShopName = $objPHPExcel->getActiveSheet()->getCell("B$row")->getValue();
		$rawShopAddress = $objPHPExcel->getActiveSheet()->getCell("C$row")->getValue();
